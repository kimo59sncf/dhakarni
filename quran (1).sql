...
--
-- Client :  localhost
-- Généré le :  Ven 24 Novembre 2023 à 18:41
...
--
-- Base de données :  `quran`
--

-- --------------------------------------------------------

--
-- Structure de la table `quran_text`
--
...
--
-- Contenu de la table `quran_text`
--
...
--
-- Structure de la table `sura_names`
--

CREATE TABLE IF NOT EXISTS `sura_names` (
`id` int(11) NOT NULL,
  `sura_number` int(11) DEFAULT NULL,
  `sura_name` varchar(255) DEFAULT NULL
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=115 ;

--
-- Contenu de la table `sura_names`
--

INSERT INTO `sura_names` (`id`, `sura_number`, `sura_name`) VALUES
(1, 1, 'الفاتحة'),
(2, 2, 'البقرة'),
(3, 3, 'آل عمران'),
(4, 4, 'النساء'),
...
--
-- Index pour la table `quran_text`
--
ALTER TABLE `quran_text`
 ADD PRIMARY KEY (`index`);

--
-- Index pour la table `sura_names`
--
ALTER TABLE `sura_names`
 ADD PRIMARY KEY (`id`), ADD KEY `sura_number` (`sura_number`);
...
--
-- AUTO_INCREMENT pour la table `quran_text`
--
ALTER TABLE `quran_text`
MODIFY `index` int(4) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6237;
--
-- AUTO_INCREMENT pour la table `sura_names`
--
ALTER TABLE `sura_names`
